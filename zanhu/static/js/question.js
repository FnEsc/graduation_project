$(function () {
    ...
    $(".question-vote").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('.question-vote').removeClass('voted');
                // // if (vote === "U") {
                // //     $(span).addClass('voted');
                // // }
                if(data.voted){
    ...
    $(".acceptAnswer").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $(".accept").removeClass("accepted")
                $(".accept").prop("title", "点击接受回答");
                $(span).addClass("accepted");
                $(span).prop("title", "该回答已被采纳");
            }
        });
    });
});
